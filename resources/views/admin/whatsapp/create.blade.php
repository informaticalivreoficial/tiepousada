...
@section('title', 'Cadastrar Número')

@section('content_header')
<div class="row mb-2">
    <div class="col-sm-6">
        <h1><i class="fas fa-envelope mr-2"></i>Cadastrar Número</h1>
    </div>
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Cadastrar Número</li>
        </ol>
    </div>
</div> 
@stop
...
<form action="{{ route('lista.numero.store') }}" method="post" autocomplete="off">
@csrf       
<div class="row">            
    <div class="col-12">
                       ...
                       <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-md-2 col-lg-2">   
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control whatsappmask" name="numero" value="{{ old('numero') }}">
                                </div>                                                    
                            </div>
                            <div class="col-12 col-sm-6 col-md-2 col-lg-2">
                                <div class="form-group">
                            ...
                            <div class="col-12 text-right"> 
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-lg btn-success" title="Cadastrar Número"><i class="nav-icon fas fa-check mr-2"></i> Cadastrar Número</button>
                                </div>
                            </div>
                       </div>                        
                    </div> 
