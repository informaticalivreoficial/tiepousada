...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1><i class="fas fa-search mr-2"></i>Editar Selo</h1>
    </div>
    <div class="col-sm-6">
...
<form action="{{ route('selos.update', ['id' => $selo->id]) }}" method="post" enctype="multipart/form-data" autocomplete="off">
@csrf
@method('PUT')          
<div class="row">            
    <div class="col-12">
                       ...
                       <div class="row mb-4">
                            <div class="col-12 col-sm-12 col-md-4 col-lg-4">   
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="titulo" value="{{old('titulo') ?? $selo->titulo}}">
                                </div>                                                    
                            </div>
                            <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control">
                                        <option value="1" {{ (old('status') == '1' ? 'selected' : ($selo->status == 1 ? 'selected' : '')) }}>Publicado</option>
                                        <option value="0" {{ (old('status') == '0' ? 'selected' : ($selo->status == 0 ? 'selected' : '')) }}>Rascunho</option>
                                    </select>
                                </div>
                            </div>                          
                            <div class="col-12 col-sm-6 col-md-4 col-lg-4">   
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="link" value="{{old('link') ?? $selo->link}}">
                                </div>                                                    
                            </div>                                                      
                        </div>
                        <div class="row">  
                            <div class="col-12 mb-1"> 
                                <div class="form-group">
                                    ...
                                    <div class="thumb_user_admin">                                                    
                                        <img id="preview1" src="{{$selo->getimagem()}}" alt="{{ old('titulo') ?? $selo->titulo }}" title="{{ old('titulo') ?? $selo->titulo }}"/>
                            ...
                            <div class="col-12">   
                                ...
                                <x-adminlte-text-editor name="content" v placeholder="Descrição do slide..." :config="$config">{{ old('content') ?? $selo->content }}</x-adminlte-text-editor>                                                      
                            </div>
                        </div>                               
