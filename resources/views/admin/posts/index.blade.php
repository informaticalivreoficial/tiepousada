                    ...
                    <tbody> 
                        ...
                        <tr style="{{ ($post->status == '1' ? '' : 'background: #fffed8 !important;')  }}">                            
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-xs btn-danger text-white j_modal_btn" data-id="{{$post->id}}" data-toggle="modal" data-target="#modal-default" {{($post->id == 18 ? 'disabled' : '')}}><i class="fas fa-trash"></i></button>
                            </td>
                        </tr>                            
                        @endforeach
                    </tbody>                
